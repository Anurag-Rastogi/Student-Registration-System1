...
function addData() {
    ...
    let clas = document.getElementById("clasInput").value;
    ...
    newRow.insertCell(1).innerHTML = clas;
...
function clearInputs() {
    ...
    document.getElementById("clasInput").value = "";
